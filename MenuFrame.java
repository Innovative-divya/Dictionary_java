...
option.setIcon(getImage("add.png"));///////////////////////////////////////////
...
option.setIcon(getImage("delete.png"));////////////////////////////////////
...
menuDictionary.addSeparator();
option= new JMenuItem("Search Word..");
option.setIcon(getImage("search.png"));/////////////////////////////////////
...
option=new JMenuItem("list Word..");
option.setIcon(getImage("list.png"));////////////////////////////////////
...
{
int option=JOptionPane.showConfirmDialog(this,"you have some pending changes.Doyou want to write them to Disk and then exit?","Save",1,3);
if (option==0)
{
...
public void addToolbar()
{
	...
	JButton b = new JButton(getImage("add.png"));
	...
	b=new JButton(getImage("delete.png"));
	b.setPreferredSize(new Dimension(32,32));
	tb.add(b);
	...
	b=new JButton(getImage("search.png"));
	b.setPreferredSize(new Dimension(32,32));
	tb.add(b);
	...
	b=new JButton(getImage("list.png"));
	tb.add(b);
	...
	tb.addSeparator();
	b=new JButton(getImage("save.png"));//////////////////////////
	tb.add(b);
	...
	b=new JButton(getImage("load.png"));/////////////////////////////////////////
	tb.add(b);
	...
	
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if(result)
			{
				...
				JOptionPane.showMessageDialog(MenuFrame.this,"Could Not Save DictionarySuccessfully! Error-->"+Dictionary.getMessage(),"Feedback",1);
			}
		}
	});
