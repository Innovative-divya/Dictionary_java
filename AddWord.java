...
public class AddWord extends JFrame{
	...
	public AddWord()
	{
		...
		this.btnAdd.addActionListener(new ActionListener(){
			...
			JOptionPane.showMessageDialog(AddWord.this,"Added Word Successfully!","AddWord",1);
		}
		else
		{
					JOptionPane.showMessageDialog(AddWord.this,"please enter word and meaning!","AddWord",0);
		}
